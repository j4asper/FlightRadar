...
public class FlightPositionEndpoints : IFlightPositionEndpoints
{
    private readonly HttpClient _httpClient;

    public FlightPositionEndpoints(HttpClient httpClient)
    {
        _httpClient = httpClient;
    }
    
    public async Task<IReadOnlyList<FlightPositionFull>> GetFullAsync(FlightPositionsFilter filter)
    {
    ...
    public async Task<IReadOnlyList<FlightPositionLight>> GetAsync(FlightPositionsFilter filter)
    {
    ...
    public async Task<int> GetCountAsync(FlightPositionsFilter filter)
    {
